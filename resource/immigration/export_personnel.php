...
$PHPExcel->getActiveSheet()->setTitle('Personnel');
...
$PHPExcel->getActiveSheet()->setCellValue('B1', 'PersonnelCode');
$PHPExcel->getActiveSheet()->setCellValue('C1', 'PersonnelName');
$PHPExcel->getActiveSheet()->setCellValue('D1', 'PersonnelBirth');
$PHPExcel->getActiveSheet()->setCellValue('E1', 'PersonnelGender');
$PHPExcel->getActiveSheet()->setCellValue('F1', 'PersonnelAddress');
$PHPExcel->getActiveSheet()->setCellValue('G1', 'PersonnelNum');
$PHPExcel->getActiveSheet()->setCellValue('H1', 'PersonnelEmail');
$PHPExcel->getActiveSheet()->setCellValue('I1', 'PersonnelActive');
$PHPExcel->getActiveSheet()->setCellValue('J1', 'PersonnelNote');
$PHPExcel->getActiveSheet()->setCellValue('K1', 'PositionId');
$PHPExcel->getActiveSheet()->setCellValue('L1', 'RoleId');
$PHPExcel->getActiveSheet()->setCellValue('M1', 'PersonnelStatus');
...
$filename = "Personnel_export_file_".date("YmdHis").".xlsx";
